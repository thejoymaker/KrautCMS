...
class TimeUtil
{
     ...
     * 
     * @param string $resource the resource to get the maximum file modification time, either a directory or a file path
     * 
     * @return int the maximum file modification time
     */
